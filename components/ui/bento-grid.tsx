...
export const BentoGridItem = ({
    ...
    const handleCopy = () => {
        navigator.clipboard.writeText('Tshegofatsorasodi@gmail.com')
        ...
        >
            <div className={`${id === 6 && "flex justify-center"} h-full`}>
                ...
                {id === 6 &&
                    ...
                    <div className={"absolute z-50 flex items-center  justify-center text-white font-black"}/>
                    </BackgroundGradientAnimation>}
